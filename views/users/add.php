            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    <div class="head">
                        ...
                        <h1 class="text-center text-danger ">Thêm mới</h1>
                        <hr>
                        <div class="clear"></div>
                    </div>
                    <div class="row">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="row-form">
                                                ...
                                                <div class="span9 "><input class="form-control shadow  " type="text" name="nameTB" required placeholder="" style="width: 700px" /></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="row-form">
                                                <div class="span3">Thông Số</div>
                                                <div class="span9"><textarea class="form-control shadow " type="text" name="parameter" placeholder="" style="width: 700px"></textarea></div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="row-form">
                                            ...
                                            <div class="row-form">
                                                ...
                                                <div class="span9"><input type="text" class="form-control shadow " required name="price" placeholder="" style="width: 700px" /></div>
