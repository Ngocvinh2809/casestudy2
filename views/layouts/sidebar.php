        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="views/login/formLogin.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="http://localhost/phone/index.php?controller=user&action=index" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                <i class="fe fe-box fe-16"></i>
                <span class="ml-3 item-text">Danh Sách</span>
              </a>
            ...
            <li class="nav-item w-100">
              <a class="nav-link" href="widgets.html">
                ...
                <span class="ml-3 item-text">Giỏ Hàng</span>
